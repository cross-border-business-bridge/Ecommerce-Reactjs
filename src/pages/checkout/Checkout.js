                    ...
                    <div className={styles.content}>
                        ...
                        <div className={styles.title}>
                            ...
                            <div className={styles.sub_title}>
                                Hi <b>{this.props.name}</b> Please review your items and press the confirm checkout
                                button. You will enter your address information while your paying on PayPal
                            </div>
                        </div>
                        {/* table */}
